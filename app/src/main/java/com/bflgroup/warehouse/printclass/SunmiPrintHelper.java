package com.bflgroup.warehouse.printclass;
    ...
    public void printText(String content, float size, boolean isBold, boolean isUnderLine,
        ...
        try {
            try {
                ...
                if (isBold) {
                    sunmiPrinterService.sendRAWData(com.bflgroup.warehouse.printclass.ESCUtil.boldOn(), null);
                } else {
                    sunmiPrinterService.sendRAWData(com.bflgroup.warehouse.printclass.ESCUtil.boldOff(), null);
                }
            }
            try {
                ...
                if (isUnderLine) {
                    sunmiPrinterService.sendRAWData(com.bflgroup.warehouse.printclass.ESCUtil.underlineWithOneDotWidthOn(), null);
                } else {
                    sunmiPrinterService.sendRAWData(com.bflgroup.warehouse.printclass.ESCUtil.underlineOff(), null);
                }
            }
