...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.getMenu().findItem(R.id.nav_receive_production).setVisible(true);
        ...
        navigationView.getMenu().findItem(R.id.nav_validate_toteid).setVisible(false);
        navigationView.getMenu().findItem(R.id.nav_item_segregation).setVisible(false);
        navigationView.getMenu().findItem(R.id.nav_supplier_box_grn).setVisible(false);
        navigationView.getMenu().findItem(R.id.nav_receive_production).setVisible(false);
        navigationView.getMenu().findItem(R.id.nav_rfid_tag_register).setVisible(false);
        ...
        for (int i = 0; i < objGlobal.getActiveMenuByUser().size(); i++) {
            ...
            if (objGlobal.getActiveMenuByUser().get(i).equals("nav_receive_production")) {
                navigationView.getMenu().findItem(R.id.nav_receive_production).setVisible(true);
            }
            ...
            if (objGlobal.getActiveMenuByUser().get(i).equals("nav_validate_toteid")) {
                navigationView.getMenu().findItem(R.id.nav_validate_toteid).setVisible(true);
            }
            if (objGlobal.getActiveMenuByUser().get(i).equals("nav_item_segregation")) {
                navigationView.getMenu().findItem(R.id.nav_item_segregation).setVisible(true);
            }
            if (objGlobal.getActiveMenuByUser().get(i).equals("nav_receive_production")) {
                navigationView.getMenu().findItem(R.id.nav_receive_production).setVisible(true);
            }
            if (objGlobal.getActiveMenuByUser().get(i).equals("nav_rfid_tag_register")) {
                navigationView.getMenu().findItem(R.id.nav_rfid_tag_register).setVisible(true);
            }
            if (objGlobal.getActiveMenuByUser().get(i).equals("nav_supplier_box_grn")) {
                navigationView.getMenu().findItem(R.id.nav_supplier_box_grn).setVisible(true);
            }
