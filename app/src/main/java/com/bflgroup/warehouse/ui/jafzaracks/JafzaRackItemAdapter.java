...
public class JafzaRackItemAdapter extends BaseAdapter {
    public ArrayList<JafzaRackHistoryModel> listStockTakingItem;
    Activity activity;

    public JafzaRackItemAdapter(Activity activity, ArrayList<JafzaRackHistoryModel> listStockTakingItem) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View myView = mInflater.inflate(R.layout.jafza_rack_list_item, null);
