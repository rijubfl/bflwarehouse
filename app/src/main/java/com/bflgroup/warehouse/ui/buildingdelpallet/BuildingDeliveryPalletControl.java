...
//            }
    ...
    public ArrayList<PalletScanDeliveryItem> TmpGinScan(Context context, String android_id, String TrfNo, String Trfdate, String ToteId, String ShopName, String Route_id, String BoxNo, String PreparedBy, String Narration, String Quantity) throws SQLException {
        ...
        if (rs.next()) {
            ...
            if (rs2.next()) {
                okMessage("", "Pallet Already Built for Trf No/Toteid", context);
            }
            else {
                if (rs1.next()) {
                    okMessage("", "Gin Already Built for Trf No/Toteid", context);
                }
                else {
    ...
    public ArrayList<PalletScanDeliveryItem> LoadPltData() throws SQLException {
        ArrayList<PalletScanDeliveryItem> arrayList = new ArrayList<>();
        String query1 = "select * from BFLDATA..tmpPalletScan where DeviceName = '" + objGlobal.getDeviceName() + "'";
